...
function App() {
  ...
  const skills = [
    { category: 'Programming', items: ['Python', 'JavaScript', 'TypeScript', 'C', 'C++', 'Shell'], icon: Code },
    { category: 'Frontend', items: ['React.js', 'HTML5', 'CSS3', 'TailwindCSS', 'Responsive Design'], icon: Code },
    { category: 'Backend', items: ['Django', 'Flask', 'REST APIs', 'PHP', 'Node.js'], icon: Server },
  ...
  const experience = [
    {
      ...
      description: 'Working under Prof. Asim Tewari on CNC monitoring systems and composite design applications.'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <div className="fixed top-0 w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-2 px-4 text-center text-sm font-medium z-50 animate-slide-down">
        Portfolio work is under progress 😊
      </div>
